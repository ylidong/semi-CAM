master.fun.AE<-function(data.mix.use_in,MKS.list.use_in,P.use_in){
  ##################
  ###CAM original###
  ##################
  ##avg estimate##
  ...
  CAM.AE=AE.fun(P.est=CAM.res$P,P.use)
  ...
  CAM.KL.AE=AE.fun(P.est=CAM.NMF.res$P.KL,P.use)
  CAM.Fro.AE=AE.fun(P.est=CAM.NMF.res$P.Fro,P.use)
  ...
  for(known.vertice in 1:ncell){
    ...
    for(j in 1:ncol(vertice.select)){
      ...
      ssCAM.KL.AE=AE.fun(P.est=ssCAM.res$P.KL,P.use)
      ssCAM.Fro.AE=AE.fun(P.est=ssCAM.res$P.Fro,P.use)
  ...
  NMF.KL.AE=AE.fun(P.est=NMF.res$P.KL,P.use)
  NMF.Fro.AE=AE.fun(P.est=NMF.res$P.Fro,P.use)
  ...
  DSA.AE=AE.fun(P.est=P.DSA,P.use)
